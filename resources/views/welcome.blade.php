    ...
    <body class="antialiased">
        ...
        <!---<div class="relative flex items-top justify-center min-h-screen bg-gray-100 dark:bg-gray-900 sm:items-center py-4 sm:pt-0">
            ...
            <div class="content-head">
                <div class="container mt-2 col-md-5" style="border:none;">
                    <div >
                        <p class="text-center bg-secondary" style="font-weight:600; font-size:25px;">Indiquez le type de formation</p>
                    </div>
                    <div class="card-footer d-grid gap-2 col-6 mx-auto bg-white" style="border:none;">
                        <div class="row">
                            @foreach ($types as $type)
                                <div class="btn-lg">
                                    <a href="/types/{{ $type['id'] }}" class="btn btn-success" style="width:170px;">{{ $type['libelleType'] }}</a>
                                </div>
                            @endforeach
                        </div>
                    </div>
        ...
        <div class="container card-footer text-muted bg-secondary ">
                ...
                <div class="col-md-3"> <a class = "btn btn-warning lg" href="/dashboard">candidats par formation</a> </div>
            </div>
        </div>
        </div>
    </body>
